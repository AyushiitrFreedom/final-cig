...
function Card() {
  ...
  return (
    <>
      <div className="Vartical-Card-Box all-initial">
        <h1>Meet Our Team</h1>
        <div className="Vertical-Box-row my-5 all-initial">
          <div className="Vertical-BTN-Box my-5 all-initial">
            <Buttons className="all-initial"
              menuItems={menuItems}
